            ...
            <div class="col-md-5">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="mb-0 card-title">Edit Expenses</h3>
                    </div>
                    <div class="card-body">
                        <?php 
                        ...
                        ?>
                        <form action="<?php echo base_url('admin/expenses/edit/'.$edit['exp_id']); ?>" method="POST">
                                ...
                                <select name="head_id" id="head_id" class="form-control">
                                    ...
                                    <?php 
                                        foreach($head_list as $value){
                                            if($edit['head_id'] == $value['eid']){
                                                echo '<option value="'.$value['eid'].'" selected>'.$value['head_name'].'</option>';
                                            }else{
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="detail" id="detail" rows="3" class="form-control" placeholder="Expenses Detail"><?php echo $edit['detail']; ?></textarea>
                                <span class="text-danger"><?php echo form_error('detail'); ?></span>
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="amount">Expenses Amount</label>
                                <input type="number" class="form-control" name="amount" value="<?php echo $edit['amount']; ?>" placeholder="Expenses Amount">
