    ...
    <div class="side-app">
        ...
        <div class="page-header">
            <ol class="breadcrumb"><!-- breadcrumb -->
                <li class="breadcrumb-item"><a href="#">Offline Supply Report</a></li>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo base_url('admin/report/offlineSupplyReport'); ?>" method="POST">
                            <div class="row">
    ...
    */
    $(document).ready(function(){  
        ...
        var dataTable = $('#report_list').DataTable({  
            ...
            "order":[],  
            "ajax":{  
                url:"<?php echo base_url('admin/report/getOfflineSupplyReport'); ?>",  
                type:"POST",
