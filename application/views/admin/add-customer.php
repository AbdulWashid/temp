							...
							<div class="col-md-12">
								...
								<div class="card">
									...
									<div class="card-body">
										...
										?>
										<form action="<?php echo base_url('admin/customer/add'); ?>" method="POST">
											<div class="row">
												<div class="col-sm-6">
											...
											<div class="row">
												<div class="col-sm-6">
													<div class="form-group">
														...
														<input type="number" class="form-control" name="kane_charge" value="20" placeholder="Per Kane Charge">
