            ...
            <div class="col-md-5">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="mb-0 card-title">Add Area</h3>
                    </div>
                    <div class="card-body">
                        <?php 
                        ...
                        ?>
                        <form action="<?php echo base_url('admin/area/add'); ?>" method="POST">
                            <div class="form-group">
                                <label class="form-label" for="area_name">Area Name</label>
                                <input type="text" class="form-control" name="area_name" value="<?php echo set_value('area_name'); ?>" placeholder="Area Name">
