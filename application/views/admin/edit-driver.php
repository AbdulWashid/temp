            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="mb-0 card-title">Edit Driver</h3>
                    </div>
                    <div class="card-body">
                        <?php 
                        ...
                        ?>
                        <form action="<?php echo base_url('admin/driver/edit/'.$edit['driver_id']); ?>" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="form-label" for="driver_name">Driver Name</label>
                                        <input type="text" class="form-control" name="driver_name" value="<?php echo $edit['driver_name']; ?>" placeholder="Driver Name">
                                        <span class="text-danger"><?php echo form_error('driver_name'); ?></span>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="form-label" for="driver_image" style="display:block;">Driver Image</label>
                                        <?php 
                                            if($edit['driver_image'] != ''){
                                                ?>
                                                <img src="<?php echo base_url('uploads/driver/'.$edit['driver_image']); ?>" height="35">
                                                <?php
                                            }
                                        ?>
                                        <input type="file" class="form-control" name="driver_image" accept="image/*" style="width:90%;display:inline-block;">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="password" value="<?php echo $edit['password']; ?>" placeholder="Password">
