        ...
        <div class="page-header">
            ...
            <div class="ml-auto">
                <div class="input-group">
                    ...
                    <a href="<?php echo base_url('admin/driver/add'); ?>" class="btn btn-primary button-icon mr-3 mt-1 mb-1">
                        <span><i class="fe fe-truck"></i>Add Driver</span>
                    </a>
                </div>
            </div>
        </div>
                                        ...
                                        if(!empty($customer_list)){
                                            ...
                                            foreach($customer_list as $value){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php 
                                                            if($value['driver_image'] != ''){
                                                                ?>
                                                                <img src="<?php echo base_url('uploads/driver/'.$value['driver_image']); ?>"height="35">
                                                                <?php
                                                            }
                                                        ?>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url('admin/driver/edit/'.$value['driver_id']); ?>" class="btn btn-sm btn-success">Edit</a>
                                                        <a href="<?php echo base_url('admin/driver/changeStatus/'.$value['driver_id'].'/'.$value['status']); ?>" onclick="return confirm('Do you want to change this record status ?')" class="btn btn-sm btn-primary">Change Status</a>
                                                        <?php 
                                                            if($value['delete'] == 'Yes'){
                                                                ?>
                                                                <a href="<?php echo base_url('admin/driver/delete/'.$value['driver_id']); ?>" onclick="return confirm('Do You Really Want To Delete This Record ?')" class="btn btn-sm btn-danger">Delete</a>
                                                                <?php
                                                            }
                                                        ?>
                                                    </td>
