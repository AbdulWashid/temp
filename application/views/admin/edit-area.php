    ...
    <div class="side-app">
        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="mb-0 card-title">Edit Area</h3>
                    </div>
                    <div class="card-body">
                        <?php 
                        ...
                        ?>
                        <form action="<?php echo base_url('admin/area/edit/'.$edit['area_id']); ?>" method="POST">
                            <div class="form-group">
                                <label class="form-label" for="area_name">Area Name</label>
                                <input type="text" class="form-control" name="area_name" value="<?php echo $edit['area_name']; ?>" placeholder="Area Name">
                                <span class="text-danger"><?php echo form_error('area_name'); ?></span>
                            </div>
            ...
            <div class="col-md-7">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="mb-0 card-title">Area List</h3>
                    </div>
                    <div class="card-body">
                                        ...
                                        if(!empty($area_list)){
                                            ...
                                            foreach($area_list as $value){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url('admin/area/edit/'.$value['area_id']); ?>" class="btn btn-sm btn-success">Edit</a>
                                                        <a href="<?php echo base_url('admin/area/delete/'.$value['area_id']); ?>" onclick="return confirm('Do You Really Want To Delete This Record ?')" class="btn btn-sm btn-danger">Delete</a>
                                                    </td>
                                                </tr>
                                                <?php
                                                $i++;
