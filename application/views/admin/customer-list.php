						...
						<div class="page-header">
							...
							<div class="ml-auto">
								<div class="input-group">
									...
									<a href="<?php echo base_url('admin/customer/add'); ?>" class="btn btn-primary button-icon mr-3 mt-1 mb-1">
										<span><i class="fe fe-user-plus"></i>Add Customer</span>
									</a>
								</div>
							</div>
						</div>
														...
														if(!empty($customer_list)){
															...
															foreach($customer_list as $value){
																...
																<tr>
																	...
																	<td><?php echo $value['kane_charge']; ?></td>
																	<td><?php echo $value['due_amount']; ?></td>
																	<td><?php echo $value['kane_stock']; ?></td>
																	<td>
																		<?php 
																	...
																	<td>
																		<a href="<?php echo base_url('admin/customer/edit/'.$value['customer_id']); ?>" class="btn btn-sm btn-success">Edit</a>
																		<?php 
																			if($value['delete'] == 'Yes'){
																				?>
																				<a href="<?php echo base_url('admin/customer/delete/'.$value['customer_id']); ?>" onclick="return confirm('Do You Really Want To Delete This Record ?')" class="btn btn-sm btn-danger">Delete</a>
																				<?php
																			}
																		?>
																		<a href="<?php echo base_url('admin/customer/changeStatus/'.$value['customer_id'].'/'.$value['status']); ?>" onclick="return confirm('Do you want to change this record status ?')" class="btn btn-sm btn-primary">Change Status</a>
																	</td>
																</tr>
																<?php
																$i++;
