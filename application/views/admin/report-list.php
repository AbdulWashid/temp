        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo base_url('admin/report/list'); ?>" method="POST">
                            <div class="row">
                                <div class="col-sm-3">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <?php 
                            if($customer_id != ''){
                                ?>
                                <a href="<?php echo base_url('admin/report/generateCart/'.$customer_id.'/'.$from_date.'/'.$to_date); ?>" class="btn btn-primary btn-md ml-auto">Generate Card</a>
                                <a href="<?php echo base_url('admin/report/viewReceipt/'.$customer_id.'/'.$from_date.'/'.$to_date); ?>" class="btn btn-primary btn-md ml-auto">Genrate Receipt</a>
                                <?php
                            }
                        ?>
                    </div>
    ...
    */
    $(document).ready(function(){  
        ...
        var dataTable = $('#report_list').DataTable({  
            ...
            "order":[],  
            "ajax":{  
                url:"<?php echo base_url('admin/report/getSupplyReport'); ?>",  
                type:"POST",
