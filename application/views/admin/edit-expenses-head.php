    ...
    <div class="side-app">
        ...
        <div class="page-header">
            <ol class="breadcrumb"><!-- breadcrumb -->
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Expenses Head</li>
            </ol><!-- End breadcrumb -->
        </div>
        <!-- PAGE-HEADER END -->
        <!-- ROW-1 OPEN -->
            ...
            <div class="col-md-5">
                <div class="card">
                    <div class="card-header">
                        <h3 class="mb-0 card-title">Edit Expenses Head</h3>
                    </div>
                    <div class="card-body">
                        <?php 
                        ...
                        ?>
                        <form action="<?php echo base_url('admin/expenses/editExpenseHead/'.$edit['eid']); ?>" method="POST" class="expenseForm">
                            <div class="form-group">
                                <label class="form-label" for="head_name">Head Name</label>
                                <input type="text" class="form-control" name="head_name" value="<?php echo $edit['head_name']; ?>" placeholder="Head Name">
